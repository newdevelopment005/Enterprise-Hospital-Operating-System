"""Application entry point for the insurance-service.

Wires up FastAPI, logging, the private database, the insurance service, and an
...
from insurance_service.api.routes import router
from insurance_service.configuration import settings
...
def create_app() -> FastAPI:
    ...
    @app.exception_handler(InsuranceError)
    async def handle_insurance_error(_request: Request, exc: InsuranceError) -> JSONResponse:
        return JSONResponse(
