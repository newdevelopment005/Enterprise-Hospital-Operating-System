"""Application entry point for the reporting-service.

Wires up FastAPI, logging, the private database, the reporting service, and an
...
from reporting_service.api.routes import router
from reporting_service.configuration import settings
from reporting_service.entity.models import Base
