...
Wires up FastAPI, logging, the private database, the inventory service, and an
...
from inventory_service.api.routes import router
from inventory_service.configuration import settings
...
def create_app() -> FastAPI:
    ...
    async def handle_inventory_error(_request: Request, exc: InventoryError) -> JSONResponse:
        return JSONResponse(
