"""Application entry point for the radiology-service.

Wires up FastAPI, logging, the private database, the radiology service, and an
...
from radiology_service.api.routes import router
from radiology_service.configuration import settings
...
def create_app() -> FastAPI:
    ...
    async def handle_radiology_error(_request: Request, exc: RadiologyError) -> JSONResponse:
        return JSONResponse(
