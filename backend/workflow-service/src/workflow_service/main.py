"""Application entry point for the workflow-service.

Wires up FastAPI, logging, the private database, the workflow service, and an
...
from workflow_service.api.routes import router
from workflow_service.configuration import settings
...
def create_app() -> FastAPI:
    ...
    async def handle_workflow_error(_request: Request, exc: WorkflowError) -> JSONResponse:
        return JSONResponse(
